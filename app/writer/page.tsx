...
const generateArtworks = () => {
  ...
  const titles = [
    "The Last Samurai - Chapter 1",
    "Moonlight Tales - Fantasy Novel",
    "Dragon's Lair - Fantasy Series",
    "Echoes of Eternity - Light Novel",
    "Whispers in the Dark - Mystery Series",
    "Academy of Magic - Chapter 1",
    "Stellar Odyssey - Sci-Fi Epic",
    "Chronicles of the Forgotten Realm",
    "The Demon Hunter's Journal",
  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      <div className="w-full">
        <MasonryGrid items={artworks} category="Writer" />
      </div>
    </div>
  )
}
