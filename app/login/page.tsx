...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-8rem)]">
      <Card className="w-full max-w-md bg-white/80 dark:bg-violet-900/30 backdrop-blur-md">
          ...
          <TabsContent value="login">
            <form onSubmit={handleLogin}>
              <CardHeader>
                ...
                <CardDescription className="text-center">Login to your Animaker account</CardDescription>
              </CardHeader>
          ...
          <TabsContent value="signup">
            <form onSubmit={handleSignup}>
              <CardHeader>
                ...
                <CardDescription className="text-center">Join the Animaker community</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="username">Username</Label>
                  <Input id="username" placeholder="coolcreator123" required />
                </div>
                <div className="space-y-2">
